...
var NON_INTERACTIVE_CLIENT_ID = process.env.WEBSITE_NON_INTERACTIVE_CLIENT_ID;
var NON_INTERACTIVE_CLIENT_SECRET =
	process.env.WEBSITE_NON_INTERACTIVE_CLIENT_SECRET;
...
function getAccessToken(req, res, next) {
	request
		.post('https://billfienberg.auth0.com/oauth/token')
		.send(authData)
